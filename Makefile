#############################################################################
# Makefile for building: integrators
# Generated by qmake (3.0) (Qt 5.0.1) on: pon. mar 18 18:09:43 2013
# Project:  integrators.pro
# Template: app
# Command: /usr/bin/qmake -spec linux-clang CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile integrators.pro
#############################################################################
...
Makefile: integrators.pro /usr/lib/qt/mkspecs/linux-clang/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		integrators.pro
	$(QMAKE) -spec linux-clang CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile integrators.pro
...
dist: 
	@test -d .tmp/integrators1.0.0 || $(MKDIR) .tmp/integrators1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/integrators1.0.0/ && (cd `dirname .tmp/integrators1.0.0` && $(TAR) integrators1.0.0.tar integrators1.0.0 && $(COMPRESS) integrators1.0.0.tar) && $(MOVE) `dirname .tmp/integrators1.0.0`/integrators1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/integrators1.0.0
...
integrators.o: integrators.cpp integrators.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o integrators.o integrators.cpp
